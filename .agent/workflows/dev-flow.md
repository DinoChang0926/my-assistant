...
- **語法檢查**：修改任何 `.py` 檔案後，必須先執行靜態語法驗證，確保語法無誤。

// turbo
```powershell
python -c "import ast; ast.parse(open('src/brain/orchestrator.py', encoding='utf-8').read()); print('Syntax OK')"
```
